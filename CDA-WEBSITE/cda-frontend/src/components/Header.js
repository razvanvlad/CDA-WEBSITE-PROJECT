            ...
            <nav className="p-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 flex items-center gap-5">
                  {/* Social icons */}
                  <a href="#" aria-label="Facebook" className="side-menu-social">
                  ...
                  <a href="#" aria-label="Instagram" className="side-menu-social">
                  ...
                  <a href="#" aria-label="LinkedIn" className="side-menu-social">
